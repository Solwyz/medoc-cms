...
function BrandPromo() {
  ...
  return (
    <div>
      <h1 className='text-xl font-medium'>Brands banner image</h1>
        ...
        <table className="w-full text-left text-[14px] border border-[#D6D6D6] font-normal border-collapse">
          <thead className='bg-[#F0F0F0] h-10 border-b'>
            <tr className="text-sm font-medium text-[#2F3139]">
              ...
              <th className="px-4 text-sm font-medium text-[#2F3139] py-2">Banner image</th>
              <th className="px-4 text-sm font-medium text-[#2F3139] py-2">Brand Name</th>
              <th className="px-4 text-sm font-medium text-[#2F3139] py-2">Category</th>
          ...
          <tbody>
            {[1, 2, 3, 4, 5].map((num) => (
              <tr key={num} className="border-b border-[#E6E6E7] hover:bg-[#F6F6F6] h-[71px] text-sm">
                ...
                <td className="px-4 py-2">Brand {num}</td>
