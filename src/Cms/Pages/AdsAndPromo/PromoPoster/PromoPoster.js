...
function PromoPoster() {
  ...
  return (
    <div>
      <h1 className='text-xl font-medium'>Promotion Poster</h1>
        ...
        <table className="w-full text-left text-[14px] border border-[#D6D6D6] font-normal border-collapse">
          <thead className='bg-[#F0F0F0] h-10 border-b'>
            <tr className="text-sm font-medium text-[#2F3139]">
              ...
              <th className="px-4 text-sm font-medium text-[#2F3139] py-2">Pages</th>
          ...
          <tbody>
            {[1, 2, 3, 4, 5].map((num) => (
              <tr key={num} className="border-b border-[#E6E6E7] h-[71px] text-sm">
                ...
                <td className="px-4 py-2">Homepage {num}</td>
                <td className="px-4 py-2">
                  <input
                    type="file"
                    accept="image/*"
