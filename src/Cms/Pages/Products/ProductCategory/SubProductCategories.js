...
import nextIcon from "../../../Assets/icons/arrow_forward_ios.svg";

function SubProductCategories() {
    ...
    <div className="">
      <div className="flex justify-between items-center">
        <div className="text-xl flex items-center font-medium">
          <p className="text-[#A2A2A2]">All Categories</p>
          <span>
        ...
        >
          <img src={addIcon} alt="Add" className="mr-2" /> Add sub Category
        </button>
      </div>
            ...
            <tbody>
              {categories.map((category, index) => (
                ...
                >
                  ...
                  <td className="px-4 py-2">{category.microCategory}</td>
